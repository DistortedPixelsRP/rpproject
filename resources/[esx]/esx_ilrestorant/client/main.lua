    ...
    ESX.TriggerServerCallback('esx_society:getVehiclesInGarage', function(garageVehicles)
      ...
      ESX.UI.Menu.Open(
        ...
        function(data, menu)
          ...
          TriggerServerEvent('esx_society:removeVehicleFromGarage', 'restaurante', vehicleProps)
      ...
      if IsControlJustReleased(0,  Keys['E']) and IsJobTrue() then
        ...
        if CurrentAction == 'delete_vehicle' then
          ...
          if Config.EnableSocietyOwnedVehicles then
            ...
            TriggerServerEvent('esx_society:putVehicleInGarage', 'restaurante', vehicleProps)
            ...
            then
              TriggerServerEvent('esx_service:disableService', 'restaurante')
            end
...
AddEventHandler('esx_restaurantejob:teleportMarkers', function(position)
  ...
  while true do
    ...
    if IsJobTrue() then
        ...
        if IsControlJustReleased(0, Keys["E"]) and isInPublicMarker then
          TriggerEvent('esx_restaurantejob:teleportMarkers', position)
        end
	...
	ESX.TriggerServerCallback('esx_restaurante:getOtherPlayerData', function(data)
		...
		function(data, menu)
			...
			if data.current.value ~= nil then
				TriggerServerEvent('esx_rstaurante:confiscatePlayerItem', GetPlayerServerId(player), itemType, itemName, amount)
