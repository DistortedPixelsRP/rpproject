...
function OpenCloakroomMenu()
	...
	if grade == 'recruit' then
		...
		table.insert(elements, {label = _U('operation_wear'), value = 'operation_wear'})
		table.insert(elements, {label = _U('desert_wear'), value = 'desert_wear'})
	elseif grade == 'officer1' then
		table.insert(elements, {label = _U('police_wear'), value = 'officer_I_wear'})
		table.insert(elements, {label = _U('operation_wear'), value = 'operation_wear'})
		table.insert(elements, {label = _U('desert_wear'), value = 'desert_wear'})
	elseif grade == 'officer2' then
		table.insert(elements, {label = _U('police_wear'), value = 'officer_II_wear'})
		table.insert(elements, {label = _U('operation_wear'), value = 'operation_wear'})
		table.insert(elements, {label = _U('desert_wear'), value = 'desert_wear'})
	elseif grade == 'officer3' then
		table.insert(elements, {label = _U('police_wear'), value = 'officer_III_wear'})
		table.insert(elements, {label = _U('operation_wear'), value = 'operation_wear'})
		table.insert(elements, {label = _U('desert_wear'), value = 'desert_wear'})
	...
	elseif grade == 'sergeant' then
		table.insert(elements, {label = _U('sargent_wear'), value = 'sergeant_wear'})
		table.insert(elements, {label = _U('operation_wear'), value = 'operation_wear'})
		table.insert(elements, {label = _U('desert_wear'), value = 'desert_wear'})
	...
	elseif grade == 'lieutenant' then
		table.insert(elements, {label = _U('teniente_wear'), value = 'lieutenant_wear'})
		table.insert(elements, {label = _U('operation_wear'), value = 'operation_wear'})
		table.insert(elements, {label = _U('desert_wear'), value = 'desert_wear'})
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'cloakroom', {
		...
		if
			...
			data.current.value == 'officer_I_wear' or
			data.current.value == 'officer_II_wear' or
			data.current.value == 'officer_III_wear' or
			...
			data.current.value == 'gilet_wear' or data.current.value == 'operation_wear' or data.current.value == 'desert_wear'
		then
...
function SendToCommunityService(player)
	ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'Menu de Servicio Comunitario', {
		...
		if community_services_count == nil then
			ESX.ShowNotification('Numero de servicios inválido.')
		else
  ...
  -- Sonny
  function openPolice()
	  if PlayerData.job and PlayerData.job.name == 'police' and not ESX.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'police_actions') and (GetGameTimer() - GUI.Time) > 150 then
		OpenPoliceActionsMenu()
  ...
  function ImpoundVehicle(vehicle)
	  local vehicleData = ESX.Game.GetVehicleProperties(vehicle);
	  ESX.Game.DeleteVehicle(vehicle) 
	  TriggerServerEvent('esx_advancedgarage:setVehicleState', vehicleData.plate, 3)
