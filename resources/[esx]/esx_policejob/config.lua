...
Config.AuthorizedVehicles = {
	Shared = {
		{ model = 'polgs350', label = 'Lexsus', price = 500 },
		{ model = 'polf430', label = 'Ferrari Policia', price = 500 },
		--{ model = 'POLICE3', label = 'K9', price = 500 },
		{ model = 'pbus', label = 'Police Prison Bus', price = 500 },
		{ model = 'psp_bmwgs', label = 'Moto Policia', price = 500 },
		{ model = 'insurgent2', label = 'Insurgente', price = 500 }
...
Config.Uniforms = {
	...
	desert_wear = {
		...
		female = {
                        ['tshirt_1'] = 160,  ['tshirt_2'] = 0,
			['torso_1'] = 42,   ['torso_2'] = 3,
			['decals_1'] = 0,   ['decals_2'] = 0,
			['arms'] = 36,
			['pants_1'] = 30,   ['pants_2'] = 3,
