...
if Config.MaxInService ~= -1 then
  TriggerEvent('esx_service:activateService', 'negocio1', Config.MaxInService)
end

TriggerEvent('esx_phone:registerNumber', 'negocio1', _U('negocio1_customer'), true, true)
TriggerEvent('esx_society:registerSociety', 'negocio1', 'Negocio1', 'society_negocio1', 'society_negocio1', 'society_negocio1', {type = 'private'})



RegisterServerEvent('esx_negocio1:getStockItem')
AddEventHandler('esx_negocio1:getStockItem', function(itemName, count)

  local _source = source
  local xPlayer = ESX.GetPlayerFromId(_source)

  TriggerEvent('esx_addoninventory:getSharedInventory', 'society_negocio1', function(inventory)
...
ESX.RegisterServerCallback('esx_negocio1:getStockItems', function(source, cb)
...
RegisterServerEvent('esx_negocio1:putStockItems')
AddEventHandler('esx_negocio1:putStockItems', function(itemName, count)
...
RegisterServerEvent('esx_negocio1:getFridgeStockItem')
AddEventHandler('esx_negocio1:getFridgeStockItem', function(itemName, count)

  local _source = source
  local xPlayer = ESX.GetPlayerFromId(_source)

  TriggerEvent('esx_addoninventory:getSharedInventory', 'society_negocio1_fridge', function(inventory)
...
ESX.RegisterServerCallback('esx_negocio1:getFridgeStockItems', function(source, cb)
...
RegisterServerEvent('esx_negocio1:putFridgeStockItems')
AddEventHandler('esx_negocio1:putFridgeStockItems', function(itemName, count)
...
RegisterServerEvent('esx_negocio1:buyItem')
AddEventHandler('esx_negocio1:buyItem', function(itemName, price, itemLabel)
    ...
    TriggerEvent('esx_addonaccount:getSharedAccount', 'society_negocio1', function(account)
...
RegisterServerEvent('esx_negocio1:craftingCoktails')
AddEventHandler('esx_negocio1:craftingCoktails', function(itemValue)
...
ESX.RegisterServerCallback('esx_negocio1:getVaultWeapons', function(source, cb)

  TriggerEvent('esx_datastore:getSharedDataStore', 'society_negocio1', function(store)
...
ESX.RegisterServerCallback('esx_negocio1:addVaultWeapon', function(source, cb, weaponName)
...
ESX.RegisterServerCallback('esx_negocio1:removeVaultWeapon', function(source, cb, weaponName)
...
ESX.RegisterServerCallback('esx_negocio1:getPlayerInventory', function(source, cb)
