...
Config.Zones = {
    ...
    Vehicles = {
        Pos          = { x = -427.69, y = 293.95, z = 82.23 },
        SpawnPoint   = { x = -420.58, y = 295.03, z = 82.23 },
...
Config.TeleportZones = {
  EnterBuilding = {
    ...
    Color     = { r = 4, g = 185, b = 250 },
    Marker    = 1,
    Hint      = _U('e_to_enter_1'),
    Teleport  = { x = -457.27, y = 284.42, z = 77.52 }
  },

  ExitBuilding = {
    Pos       = { x = -459.07, y = 284.77, z = 77.52 },
    Size      = { x = 1.2, y = 1.2, z = 0.1 },
    Color     = { r = 4, g = 185, b = 250 },
    Marker    = 1,
    Hint      = _U('e_to_exit_1'),
    Teleport  = { x = -431.3, y = 256.47, z = 82.0 },
  },
