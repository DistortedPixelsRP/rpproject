...
Config.CarGarages = {
	Garage_CentralLS = {
		GaragePoint = { x = 259.6, y = -777.96, z = 29.727 },
		SpawnPoint = { x = 239.93, y = -770.78, z = 29.5722, h = 157.97 },
	...
	Garage_Paleto = {
		GaragePoint = { x = -73.24, y = 6567.69, z = 30.49 },
		SpawnPoint = { x = -66.84, y = 6559.34, z = 31.49, h = 315.01 },
		DeletePoint = { x = -84.79, y = 6558.62, z = 30.49 }
	},
	Garage_Prison = {
	...
	Garage_Policia = {
		GaragePoint = { x = 428.9, y = -994.6, z = 24.8 },
		SpawnPoint = { x = 424.76, y = -1020.91, z = 28.09, h = 89.19 },
		DeletePoint = { x = 434.5, y = -1015.06, z = 28.77 }
	},
	Garage_Cubos2= {
		GaragePoint = { x = 98.78, y = -1076.88, z = 28.24 },
		SpawnPoint = { x = 139.72, y = -1076.08, z = 28.19, h = 84.44 },
		DeletePoint = { x = 133.06, y = -1059.74, z = 28.19 }
	},
	Garage_Taxistas= {
		GaragePoint = { x = 896.21, y = -143.58, z = 75.85 },
		SpawnPoint = { x = 897.38, y = -133.69, z = 75.99, h = 225.14 },
		DeletePoint = { x = 902.34, y = -143.43, z = 75.63 }
	},
	Garage_Mecanicos= {
		GaragePoint = { x = -357.63, y = -121.42, z = 37.7 },
		SpawnPoint = { x = -356.3, y = -113.93, z = 38.7, h = 77.0 },
		DeletePoint = { x = -365.41, y = -108.28, z = 37.7 }
	},
	Garage_Eventoizi= {
		GaragePoint = { x = -410.71, y = 1239.95, z = 325.67 },
		SpawnPoint = { x = -407.54, y = 1224.29, z = 325.64, h = 165.8 },
		DeletePoint = { x = -396.97, y = 1235.5, z = 325.64 }
	},
	Garage_viniedo= {
		GaragePoint = { x = -1926.39, y = 2042.03, z = 139.83 },
		SpawnPoint = { x = -1912.3, y = 2039.7, z = 139.74, h = 218.35 },
		DeletePoint = { x = -1919.78, y = 2047.21, z = 139.74 }
	}
...
Config.AircraftGarages = {
	...
	Garage_Estacionamiento = {
		GaragePoint = { x = -736.1, y = -1457.56, z = 4.0 },
		SpawnPoint = { x = -726.28, y = -1445.53, z = 4.0, h = 317.12 },
		DeletePoint = { x = -746.17, y = -1469.69, z = 4.0 }
	}
}
