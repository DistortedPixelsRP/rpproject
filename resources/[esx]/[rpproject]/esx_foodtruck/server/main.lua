...
AddEventHandler('onMySQLReady', function ()
	MySQL.Async.fetchAll("SELECT * FROM `shops_custom` WHERE `store` = 'Market'",
		{},
		function(result)
...
ESX.RegisterUsableItem('choripan', function(source)
	local xPlayer = ESX.GetPlayerFromId(source)
	xPlayer.removeInventoryItem('choripan', 1)
	TriggerClientEvent('esx_status:add', source, 'hunger', 500000)
	TriggerClientEvent('esx_basicneeds:onEat', source, 'prop_food_burg3')
    TriggerClientEvent('esx:showNotification', source, _U('eat_choripan'))
end)

ESX.RegisterUsableItem('fajita', function(source)
	local xPlayer = ESX.GetPlayerFromId(source)
	xPlayer.removeInventoryItem('fajita', 1)
	TriggerClientEvent('esx_status:add', source, 'hunger', 500000)
	TriggerClientEvent('esx_basicneeds:onEat', source, 'prop_food_cb_bag_02')
    TriggerClientEvent('esx:showNotification', source, _U('eat_fajita'))
end)

ESX.RegisterUsableItem('tamal', function(source)
	local xPlayer = ESX.GetPlayerFromId(source)
	xPlayer.removeInventoryItem('tamal', 1)
	TriggerClientEvent('esx_status:add', source, 'hunger', 500000)
	TriggerClientEvent('esx_basicneeds:onEat', source, 'prop_food_bs_burger2')
    TriggerClientEvent('esx:showNotification', source, _U('eat_tamal'))
end)