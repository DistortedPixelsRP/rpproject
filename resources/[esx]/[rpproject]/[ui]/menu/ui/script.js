$(document).ready(function(){
  ...
  $('.openCoffre').on('click', function(e){
    ...
    $(this).find('.text').text($(this).find('.text').text() == 'Abrir vaul' ? 'Cerrar vaul' : 'Abrir vaul');
  });
  ...
  $('.openCapot').on('click', function(e){
    ...
    $(this).find('.text').text($(this).find('.text').text() == 'abrir capó' ? 'Cerrar capó' : 'abrir capó');
  });
  ...
  $('.lock').on('click', function(e){
    ...
    $(this).find('.text').text($(this).find('.text').text() == 'Cerrar Auto' ? 'Abrir auto' : 'Cerrar Auto');
  });
