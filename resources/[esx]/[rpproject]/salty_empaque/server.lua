...
RegisterServerEvent('salty_empaque:getPlayerInventory')
AddEventHandler('salty_empaque:getPlayerInventory', function()
	local _source = source
	local xPlayer = ESX.GetPlayerFromId(_source)
	if xPlayer ~= nil then
		TriggerClientEvent('salty_empaque:openMenu', _source, xPlayer.inventory)
	end
end)
...
RegisterServerEvent('salty_empaque:craftItem')
AddEventHandler('salty_empaque:craftItem', function(ingredients)
	local _source = source
	local xPlayer = ESX.GetPlayerFromId(_source)
