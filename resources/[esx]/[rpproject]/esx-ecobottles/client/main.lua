...
Citizen.CreateThread(function()
    ...
    while true do
        ...
        if DoesEntityExist(entity) and entityDst <= 1.5 then
            ...
            ESX.Game.Utils.DrawText3D(binCoords + vector3(0.0, 0.0, 0.5), "[~g~E~s~] Buscar en la Basura", 0.4)
            ...
            if IsControlJustReleased(0, 38) then
                if not cachedBins[entity] then
                    ...
                    ESX.ShowNotification("Ya has revisado esta basura!")
                end
            end
        end
