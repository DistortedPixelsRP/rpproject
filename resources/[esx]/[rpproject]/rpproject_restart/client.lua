...
Kicktime = 2 --leave on 1 second to make a fast restart, or 0 seconds to make a instant restart.
			...
			if currentPos == prevPos then
				if time > 0 then
					if kickWarning and time == math.ceil(Kicktime / 4) then
						TriggerEvent("chatMessage", "Advertencia", {255, 0, 0}, "IGNORA ESTO " .. time .. " ISI NO SABES LO QUE HACES, PLACEFILLER")
					end
