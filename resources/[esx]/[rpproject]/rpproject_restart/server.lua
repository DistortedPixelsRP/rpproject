...
lang = 'es' -- languages are: en = english, de = deutsch, fr = français
...
if lang == 'es' then
	kick_message = "Todas las situaciones de Roleplay terminaron automáticamente. Tu progreso ha sido guardado. Motivo: reinicio del servidor."
	kick_message_before_join = "¡El servidor se está reiniciando! por favor vuelva a intentarlo más tarde."
	permissions = "^3SYSTEM: ^1You have no permissions!"
	have_permissions = "^3SYSTEM: ^2You have permissions!"
end
