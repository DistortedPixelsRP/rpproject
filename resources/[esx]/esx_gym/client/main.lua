...
Citizen.CreateThread(function()
    while true do
        ...
        for k in pairs(arms) do
            ...
            if dist <= 0.5 then
				hintToDisplay('Presiona ~INPUT_CONTEXT~ para hacer ~g~brazos')
				...
				if IsControlJustPressed(0, Keys['E']) then
					if training == false then
						...
						if membership == true then
							...
							ESX.ShowNotification("Necesitas descansar ~r~30 segundos ~w~ entre ejercicios")
						...
						elseif membership == false then
							ESX.ShowNotification("Necesitas una membresia para realizar el ~r~ejercicio")
						end
...
Citizen.CreateThread(function()
    while true do
        ...
        for k in pairs(chins) do
            ...
            if dist <= 0.5 then
				hintToDisplay('Presiona ~INPUT_CONTEXT~ para hacer ~g~barra')
...
function CheckTraining()
	if resting == true then
		ESX.ShowNotification("Empiezas a descansar")
	...
	if resting == false then
		ESX.ShowNotification("Ahora si ya descanaste, puedes ejercitarte nuevamente!")
	end
end
...
function OpenGymShopMenu()
    ...
    ESX.UI.Menu.Open(
        'default', GetCurrentResourceName(), 'gym_shop_menu',
        {
            title    = 'Gym - Shop',
            elements = {
				{label = 'Protein Shake ($750)', value = 'protein_shake'},
				{label = 'Water ($120)', value = 'water'},
				{label = 'Sportlunch ($500)', value = 'sportlunch'},
				{label = 'Powerade ($1000)', value = 'powerade'},
				--{label = 'Bandage ($300)', value = 'bandage'},
            }
        },
        function(data, menu)
