...
Config.Vehicles = {
	Truck = {
		Spawner = 1,
		Label = 'Camion de Agua y Electricidad',
		Hash = "boxville",
		Livery = 0,
		Trailer = "none",
	}	
...
Config.Zones = {
  ...
  Cloakroom = {
	...
	BlipSprite = 354,
	BlipColor = 46,
	BlipName = Config.nameJobLabel.." : Comenzar a trabajar en la ciudad",
  ...
  Vente = {
	...
	Color = {r = 11, g = 203, b = 159},
	Type  = 1,
	BlipName = Config.nameJobLabel.." : Retirar dinero del trabajo",

	ItemTime = 500,
	ItemDb_name = "pay_works",
	ItemName = "Factura de Trabajo por La Ciudad",
	ItemMax = 10,
	ItemAdd = 1,
	ItemRemove = 1,
	ItemRequires = "pay_works",
	ItemRequires_name = "Factura de Trabajo por La Ciudad",
	ItemDrop = 100,
	ItemPrice  = 600,
	hint = 'Presiona ~INPUT_CONTEXT~ para cobrar tu cheque',
  },
