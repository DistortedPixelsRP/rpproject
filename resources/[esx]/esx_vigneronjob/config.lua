...
Config.Zones = {
	...
	TraitementJus = {
		...
		Size  = {x = 3.5, y = 3.5, z = 2.0},
		Color = {r = 136, g = 243, b = 216},
		Name  = "Tratamiento de Jugo de Uvas",
		Type  = 1
	},
