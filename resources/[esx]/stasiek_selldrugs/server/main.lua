...
AddEventHandler('drugsInProgress', function(street1, street2, sex)
      TriggerClientEvent("outlawNotify", -1, "~r~Persona vendiendo droga con el sexo ~w~"..sex.."~r~cerca de~w~"..street1.."~r~ y ~w~"..street2)
...
AddEventHandler('drugsInProgressS1', function(street1, sex)
      TriggerClientEvent("outlawNotify", -1, "~r~Persona vendiendo droga con el sexo ~w~"..sex.."~r~cerca de~w~"..street1)
