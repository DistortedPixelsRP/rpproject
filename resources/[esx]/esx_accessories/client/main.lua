...
function OpenAccessoryMenu()
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'set_unset_accessory',
	{
		...
		elements = {
			...
			{label = "Opciones de ropa", value = 'clothes'}

		}
	}, function(data, menu)
		menu.close()

		if string.lower(data.current.value) == "clothes" then
...
Citizen.CreateThread(function()
	while true do
		...
		if Config.EnableControls then
			if IsControlJustReleased(0, Keys['H']) and IsInputDisabled(0) and not isDead then
				OpenAccessoryMenu()
			end
		end
