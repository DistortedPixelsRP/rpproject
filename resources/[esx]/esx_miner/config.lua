...
Config.Locale       = 'en'
Config.Time 		= '350' --Tiempo por piedra en MS
Config.IronSellPrice = 45
Config.CopperSellPrice = 55
Config.GoldSellPrice = 65
Config.SulfurSellPrice = 70
Config.DiamondSellPrice= 150
...
Config.Stones = {
	...
	Stone3 = {
		Pos = {x = 2955.87, y = 2774.41, z = 38.75},
		Size = {x = 1.0, y = 1.0, z = 1.0},
		Color = {r = 204, g = 204, b = 0},
		Marker = 0,
		Blip = true,
	...
	Stone4 = {
		Pos = {x = 2936.08, y = 2785.01, z = 38.75},
		Size = {x = 1.0, y = 1.0, z = 1.0},
		Color = {r = 204, g = 204, b = 0},
		Marker = 0,
		Blip = true,
